...
class FinnhubDemo:
    ...
    def get_finnhub_client():
        configuration = finnhub.Configuration(
            api_key={
                'token': 'brqa6r7rh5rc4v2pje5g'
            }
        )

        return finnhub.DefaultApi(finnhub.ApiClient(configuration))


# Obtain the client
finnhub_client = FinnhubDemo.get_finnhub_client()

# Everything below is just a copy/paste from official documentation
